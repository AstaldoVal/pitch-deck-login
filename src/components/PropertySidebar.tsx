...
import { Home, Building2, Users, Settings, MessageCircle, ArrowLeft, Gavel, Briefcase, DollarSign, BarChart3, HardHat, FileText, ClipboardList, ClipboardCheck } from "lucide-react";
...
const getPropertyItems = () => {
  ...
  return [
    ...
    { title: "Inspections", url: "/property/renovation-inspections", icon: ClipboardCheck },
