                  ...
                  <section className="space-y-8 pt-8 border-t-2 border-border/60">
                    {!hasRentRoll ? (
                      ...
                      <>
                        ...
                        {/* Units selection is the scope for Unit-Based approach */}
                        <div className="text-center py-8">
                          <div className="max-w-md mx-auto">
                            <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                              <Home className="h-8 w-8 text-primary" />
                            </div>
                            <h3 className="text-lg font-medium mb-2">Unit-Based Scope Complete</h3>
                            <p className="text-sm text-muted-foreground">
                              {units.filter(u => u.selected).length > 0 
                                ? `${units.filter(u => u.selected).length} units selected for renovation. Contractors will bid per unit.`
                                : "Select units above to define your renovation scope."
                              }
                            </p>
                          </div>
                        </div>
