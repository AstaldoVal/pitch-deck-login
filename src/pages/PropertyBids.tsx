        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex-1 p-6 pb-24 space-y-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-1 text-base">Generate detailed renovation proposals for contractors</p>
            </div>
            ...
            {currentStep === 1 && (
              ...
              <section className="space-y-4">
                ...
                {/* Bid Details and Contact Information */}
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  {/* Bid Details */}
                  <div className="space-y-3">
                    <div className="flex items-center gap-2 mb-2">
                      <FileText className="h-4 w-4 text-primary" />
                      <h3 className="text-base font-medium">Bid Details</h3>
                    </div>
                    <div className="space-y-3 pl-6">
                      <div>
                        <Label className="text-xs text-muted-foreground">Bid Number</Label>
                        <p className="font-semibold text-lg mt-0.5">{generateBidNumber()}</p>
                      </div>
                      <div>
                      ...
                      {propertyData && (
                        <div>
                          ...
                          <p className="font-medium mt-0.5 text-sm">{propertyData.assetManager || "Not assigned"}</p>
                        </div>
                      )}
                    </div>
                  </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-3 pl-6">
                        <div>
                          ...
                          <p className="font-medium mt-0.5 text-sm">{propertyData.name}</p>
                        </div>
                        <div>
                          <Label className="text-xs text-muted-foreground">Address</Label>
                          <p className="font-medium mt-0.5 text-sm">{propertyData.address}</p>
                          <p className="text-xs text-muted-foreground">{propertyData.city}, {propertyData.state} {propertyData.zip}</p>
                        </div>
                        <div className="grid grid-cols-2 gap-3">
                          <div>
                            <Label className="text-xs text-muted-foreground">Year Built</Label>
                            <p className="font-medium mt-0.5 text-sm">{propertyData.yearBuilt || "N/A"}</p>
                          </div>
                          <div>
                            <Label className="text-xs text-muted-foreground">Building Type</Label>
                            <p className="font-medium mt-0.5 text-sm">{propertyData.buildingType || "N/A"}</p>
                          </div>
                        </div>
                      </div>
                    </div>
